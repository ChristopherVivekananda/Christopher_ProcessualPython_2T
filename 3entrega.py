lista = ["Arthur", "Beatriz", "Caio", "Daniela", "Eduardo", "Fernanda", "Gabriel", "Helena", "Igor", "Júlia",
...
for lista in lista:
    calculadora +=  1
    numeros = calculadora % 15
    if numeros == 0:
        print("15 nomes identificados!")
    print(lista)
    if lista == "Úrsula":
        print("Bônus")
    if calculadora == 85:
        print("vish, ocorreu um erro meu bro")
        break
